 ...
 * {@link hu.bp.portletsec.sqlinjection.service.impl.ColorLocalServiceImpl} and is the
...
public class ColorLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link hu.bp.portletsec.sqlinjection.service.impl.ColorLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static hu.bp.portletsec.sqlinjection.model.Color addColor(
	...
	*/
	public static hu.bp.portletsec.sqlinjection.model.Color createColor(
		long colorid) {
	...
	*/
	public static hu.bp.portletsec.sqlinjection.model.Color deleteColor(
		hu.bp.portletsec.sqlinjection.model.Color color) {
	...
	*/
	...
	public static hu.bp.portletsec.sqlinjection.model.Color fetchColor(
		long colorid) {
	...
	*/
	public static hu.bp.portletsec.sqlinjection.model.Color fetchColorByUuidAndGroupId(
	...
	* @throws PortalException if a color with the primary key could not be found
	*/
	public static hu.bp.portletsec.sqlinjection.model.Color getColor(
		long colorid)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static hu.bp.portletsec.sqlinjection.model.Color getColorByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static hu.bp.portletsec.sqlinjection.model.Color updateColor(
		hu.bp.portletsec.sqlinjection.model.Color color) {
	...
	*/
	...
	public static java.util.List<hu.bp.portletsec.sqlinjection.model.Color> getAllColors() {
		return getService().getAllColors();
	}
	...
	*/
	public static java.util.List<hu.bp.portletsec.sqlinjection.model.Color> getColors(
		int start, int end) {
	...
	*/
	public static java.util.List<hu.bp.portletsec.sqlinjection.model.Color> getColorsByUuidAndCompanyId(
	...
	*/
	public static java.util.List<hu.bp.portletsec.sqlinjection.model.Color> getColorsByUuidAndCompanyId(
		...
		return getService()
				   .getColorsByUuidAndCompanyId(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	*/
	...
	private static ServiceTracker<ColorLocalService, ColorLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ColorLocalService.class);
}