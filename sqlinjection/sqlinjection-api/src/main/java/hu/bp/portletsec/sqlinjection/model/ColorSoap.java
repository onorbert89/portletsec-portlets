...
/**
 * This class is used by SOAP remote services, specifically {@link hu.bp.portletsec.sqlinjection.service.http.ColorServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see hu.bp.portletsec.sqlinjection.service.http.ColorServiceSoap
 * @generated
 */
@ProviderType
public class ColorSoap implements Serializable {
	public static ColorSoap toSoapModel(Color model) {
		...
		soapModel.setColorCode(model.getColorCode());
