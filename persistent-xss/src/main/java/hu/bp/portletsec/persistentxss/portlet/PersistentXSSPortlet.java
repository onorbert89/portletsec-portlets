package hu.bp.portletsec.persistentxss.portlet;
...
import hu.bp.portletsec.persistentxss.constants.PersistentXSSPortletKeys;
...
public class PersistentXSSPortlet extends MVCPortlet {
	...
	private PortletPreferences setMessage(ActionRequest request, String entry){
		...
		try {
			prefs.setValue(userId + "message", message);
